// ignore_for_file: unnecessary_this, use_build_context_synchronously, unused_catch_clause, prefer_typing_uninitialized_variables, unnecessary_new
import 'dart:io';
import 'dart:async';
                                    ...
                                    onPressed: () async {
                                      setState(() {
                                        hazob1 = Hazob(
                                          ...
                                          perbaikanDilakukan:
                                              _perbaikanDilakukanController
                                                  .text,
                                          perbaikanDiusulkan:
                                              _perbaikanDiusulkanController
                                                  .text,
                                          ...
                                          lampiranFoto:
                                              "https://drive.google.com/file/d/$foto/view?usp=sharing",
                                        );
                                      });

                                      HazobSheetsApi.insert([hazob1.toJson()]);
                                      aksesList.clear();
